...
class AC_PrecLand_IRLock_RTK : public AC_PrecLand_Backend
{
public:

    // Constructor
    AC_PrecLand_IRLock_RTK(const AC_PrecLand& frontend, AC_PrecLand::precland_state& state);
    ...
    bool alternative() override { return _use_rtk; }
