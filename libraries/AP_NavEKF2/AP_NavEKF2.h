...
private:
    ...
    const uint16_t posRetryTimeUseVel_ms = 300;  // Position aiding retry time with velocity measurements (msec)
    const uint16_t posRetryTimeNoVel_ms = 300;    // Position aiding retry time without velocity measurements (msec)
